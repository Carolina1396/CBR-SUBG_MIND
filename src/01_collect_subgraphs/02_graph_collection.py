...
if __name__ == '__main__':
    ...
    parser.add_argument("--collected_chains_name", default= "../00_data/subgraphs/MIND_chains_collection_3hops_1000_paths.pkl", help = "File name of the collected chains")
